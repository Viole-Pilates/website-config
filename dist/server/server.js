...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Kwn9lUD1.js");
...
const manifest = {
  "d4dcf1107b01f198d2c3062f92c1306e7a8c4af80ac2593280df60d6c8f01b0e": {
    functionName: "createBooking_createServerFn_handler",
    importer: () => import("./assets/bookings.functions-DpwVQDe0.js")
  },
  "e3d4e9275e454df7b7d69f5e0fdcdec509bcf137174afd0fd8f0b64751c91b2d": {
    functionName: "listBookings_createServerFn_handler",
    importer: () => import("./assets/bookings.functions-DpwVQDe0.js")
  },
  "3e73649da33577c3a9d616cdb8c39470d67d05d35cbfca2e0426fdca2c2574d2": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-C6_YuW_1.js"),
